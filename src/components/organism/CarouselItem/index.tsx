...
const CarouselItem: React.FC<ICarouselItem> = ({
  ...
  return (
    <div
      className={
        'h-screen max-h-[1000px] min-h-[793px] w-screen overflow-hidden'
      }
    >
      <Image
        src={banner}
        ...
        width={1920}
        height={1080}
        className="-z-10 h-screen max-h-[1000px] min-h-[780px] w-screen scale-110 object-cover blur-sm brightness-50"
      />
      <div className="absolute left-0 top-0 h-screen max-h-[1000px] min-h-[793px] w-screen pt-20 md:pt-32">
