...
import { ICartResume } from './types'

export const CartResume: FC<ICartResume> = ({ onHandlePurchase }) => {
  return (
    <div
      className={
    ...
    >
      ...
      <div className={'flex w-full flex-col items-center gap-2'}>
        <Button.Root
          ...
          className="w-full bg-emerald-500 font-semibold hover:bg-emerald-700"
        >
          IR PARA PAGAMENTO
        </Button.Root>
