...
const DetailsImageAndPriceWrapper: React.FC<IDetailsImageAndPriceWrapper> = ({ isbn, image, discountPrice, price, title }): ReactElement => {
  return (
    <div className={'flex w-full flex-col items-center justify-center gap-5 lg:flex-row lg:gap-20'}>
      ...
      <DetailsPriceCard price={price} title={title} discountPrice={discountPrice} isbn={isbn} />
    </div>
  )
}
